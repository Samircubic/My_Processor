...
int push (stack_t *stk, double elem)
{
    ...
    if (stk->size == stk->capacity) //TODO func
    {
        ...
        stk->data = ((STACK_ELEM*) realloc (stk->data - OFFSET_BIRD, ((long unsigned int) (new_capacity + 3)) * sizeof (STACK_ELEM))) + OFFSET_BIRD; //TODO magic-const
...
int pop (stack_t *stk, double *elem)
{
    ...
    if (stk->size + DELTA_REALLOC < stk->capacity / MEMORY_MULTIPLIER) //TODO func
    {
        ...
        stk->data = ((STACK_ELEM*) realloc (stk->data - OFFSET_BIRD, ((long unsigned int) (new_capacity + 3)) * sizeof (STACK_ELEM))) + OFFSET_BIRD; //TODO rename
        stk->capacity = new_capacity;
